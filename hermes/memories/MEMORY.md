...
§
Taiff Connect: api.taiff-connect.com.br. Express+TypeORM+PG+EKS(Helm). gp2 PVC 2Gi. RabbitMQ api-taiff/taif@@. SendGrid trial 03/ago. Twilio SMS OK. Swagger /api-docs. Fotos /uploads/profiles. Profile campos PT. Google Web: tokeninfo API. Git: liniker/linikers@hotmail.com.
§
