...
§
Taiff Connect: api.taiff-connect.com.br. Express+TypeORM+PG no EKS. SendGrid trial. Google OAuth2 PRODUÇÃO + Firebase mobile. Forgot-password email+SMS. Profile campos PT. Git: liniker/linikers@hotmail.com.
§
